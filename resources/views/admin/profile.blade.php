                    ...
                    <div class="content">
                        <div class="author">
                            {{--  @if(!empty(auth()->user()->Profile->profile_picture))  --}}
                                <img class="avatar border-white" src="{{ asset('assets/img/faces/face-2.jpg') }}" alt="..."/>
                            {{--  @else  --}}
                                {{--  <img class="avatar border-white" src="{{ asset('assets/img/faces/face-2.jpg') }}" alt="..."/>  --}}
                            {{--  @endif  --}}
                        ...
                        <ul class="list-unstyled team-members">
                            ...
                            <li>
                                <div class="row">
                                    <div class="col-xs-3">
                                        <div class="avatar">
                                            <img src="{{ asset('assets/img/faces/face-1.jpg') }}" alt="Circle Image" class="img-circle img-no-padding img-responsive">
                                        </div>
                                    </div>
                                    <div class="col-xs-6">
                                        Creative Tim
